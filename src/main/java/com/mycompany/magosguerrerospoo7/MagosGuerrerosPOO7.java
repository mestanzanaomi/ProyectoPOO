 ...
 * @author Anthony
 */
public class MagosGuerrerosPOO7 {
    ...
    public static void main(String[] args) {
        ...
        equipo1.agregarPersonaje(new Guerrero("Guerrero Rojo 2", 250, 16, 10));
        equipo1.agregarPersonaje(new Mago("Mago Rojo", 150, 12, 5,equipo1));
        ...
        equipo2.agregarPersonaje(new Mago("Mago Azul", 150, 13, 5,equipo2));
        ...
        if (ronda > 15 && !equipo1.estaDerrotado() && !equipo2.estaDerrotado()) {
            ...
            System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
            System.out.println("Vida total del " + equipo1.getNombre() + ": " + vidaTotalEquipo1);
